package co.kr.itforone.demetory;
...
import co.kr.itforone.demetory.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshToken();
        //스플래시 실행
        Intent startIntent = new Intent(co.kr.itforone.demetory.MainActivity.this, SplashActivity.class);
    ...
    WebChromeClient chrome;
    {
        chrome = new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                new AlertDialog.Builder(co.kr.itforone.demetory.MainActivity.this)
                        .setMessage("\n" + message + "\n")
                        .setCancelable(false)
            ...
            public void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback callback) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(co.kr.itforone.demetory.MainActivity.this);
            ...
            public boolean onShowFileChooser(
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {// API 24 이상 일경우..
                    File imageStorageDir = new File(co.kr.itforone.demetory.MainActivity.this.getFilesDir() + "/Pictures", "main_image");
                    ...
                    Uri providerURI = FileProvider.getUriForFile(co.kr.itforone.demetory.MainActivity.this, co.kr.itforone.demetory.MainActivity.this.getPackageName() + ".provider", file);
